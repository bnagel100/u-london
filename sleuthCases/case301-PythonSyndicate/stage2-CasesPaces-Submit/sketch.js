...
function draw()
{
	...
	image(lina_lovelace_image, rocky_kray_location_x - 586, rocky_kray_location_y);
	image(anna_karpinski_image, rocky_kray_location_x - 293, rocky_kray_location_y);
	image(cecil_karpinski_image, rocky_kray_location_x - 586, rocky_kray_location_y + 269);
	image(countess_hamilton_image, rocky_kray_location_x - 293, rocky_kray_location_y + 269);
	image(robbie_kray_image, rocky_kray_location_x, rocky_kray_location_y + 269);
