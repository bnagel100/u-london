...
Officer: 9645752
CaseNum: 303-0-31748404-9645752
...
The first safe is in Torvald’s office. Crack it by doing the following:
	...
	- Make SecretVaultKey_a equal to 8

	When any key is pressed:
	- Make SecretVaultKey_a equal to 19

	Whilst the mouse is being dragged:
	- Make SecretVaultKey_a equal to 6

	When the mouse button is pressed:
	- Make SecretVaultKey_a equal to 2

	When any key is pressed:
	- Make SecretVaultKey_b equal to 1

	When the mouse button is released:
	- Make SecretVaultKey_b equal to 0

	When any key is released:
	- Make SecretVaultKey_b equal to 60

	When the mouse button is pressed:
	- Make SecretVaultKey_b equal to 64
...
var SecretVaultKey_a;
var SecretVaultKey_b;
...
function draw()
{
	...
	drawDial(200, SecretVaultKey_a, 21);
	pop();

	//Draw the lever
	push();
	translate(width - 125,256);
	drawLever(SecretVaultKey_b);
	pop();
